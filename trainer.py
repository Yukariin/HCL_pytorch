...
from metrics.average import AverageMeter, KeyValueAverageMeter
from metrics.bce import BinaryCrossEntropy

from model import HCL, RefineNet, Classifier
from discriminator import PatchDiscriminator
from vgg import VGG19FeatureExtractor
from loss.contrast_loss import HierarchicalContrastiveLoss
...
class Trainer:
    ...
    def run_step_G(self, batch):
        ...
        batch_X, batch_gt_img, batch_mask = batch
